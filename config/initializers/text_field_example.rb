...
module ActionView
  module Helpers #:nodoc:
    ...
    module PrototypeHelper
      # alias_method :form_for_without_example, :form_for
      #     
      # def form_for(*args, &block)
      #   if args.last.is_a?(Hash) && args.last[:has_example_text]
      #     form_for_without_example(*args) do |*block_args|
      #       # Alas, the example text registers onsubmit handlers which need to run BEFORE the onsubmit handler
      #       # generated by form_for that actually does the ajax call. So we rip that handler out here,
      ...
      #     end
      #   else
      #     form_for_without_example(*args, &block)
      #   end
      # end
    end
